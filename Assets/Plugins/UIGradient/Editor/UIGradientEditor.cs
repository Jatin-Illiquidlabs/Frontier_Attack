...
namespace JoshH.UI
{
    ...
    public class UIGradientEditor : Editor
    {
        ...
        private SerializedProperty _overrideRectTransform;
        ...
        private void OnEnable()
        {
            ...
            _overrideRectTransform = serializedObject.FindProperty("overrideRectTransform");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.ObjectField(_overrideRectTransform);
